...
config :rescutex, RescutexWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: RescutexWeb.ErrorHTML, json: RescutexWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Rescutex.PubSub,
  live_view: [signing_salt: "R66z/XQK"]
...
config :rescutex, Rescutex.Mailer, adapter: Swoosh.Adapters.Local
